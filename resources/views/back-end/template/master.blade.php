...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('source/assets/images/favicon.ico')}}">

    <!-- App css -->
    <link href="{{asset('source/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('source/assets/css/icons.css')}}" rel="stylesheet" type="text/css" />
...
@yield('body')
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-disc"></i><span class="badge badge-info badge-pill float-right">10</span> <span> Forms </span></a>
    ...
    <!-- jQuery  -->
    <script src="{{asset('source/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('source/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('source/assets/js/metisMenu.min.js')}}"></script>
    <script src="{{asset('source/assets/js/waves.js')}}"></script>
    <script src="{{asset('source/assets/js/jquery.slimscroll.js')}}"></script>
    ...
    <!-- Dashboard Init -->
    <script src="{{asset('source/assets/pages/jquery.dashboard.init.js')}}"></script>

    <!-- App js -->
    <script src="{{asset('source/assets/js/jquery.core.js')}}"></script>
    <script src="{{asset('source/assets/js/jquery.app.js')}}"></script>
    </body>
</html>